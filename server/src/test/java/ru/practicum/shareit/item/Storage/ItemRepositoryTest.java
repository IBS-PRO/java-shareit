...
class ItemRepositoryTest {
    ...
    void getItemsByQuery_isValid() {
        assertEquals(List.of(createdItem2), itemRepository.getItemsByQuery("testItem2"));
    }

    @Test
    void getItemsByQuery_isInvalid() {
        assertEquals(List.of(), itemRepository.getItemsByQuery("asdasdasgas"));
    }
    ...
    void getItemsByRequestIn() {
        assertEquals(List.of(createdItem1), itemRepository.getItemsByRequestIn(List.of(createdRequest1)));
    }

    @Test
    void getItemsByRequest() {
        assertEquals(List.of(createdItem2), itemRepository.getItemsByRequest(createdRequest2));
    }
}
